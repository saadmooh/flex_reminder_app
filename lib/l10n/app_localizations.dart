...
class AppLocalizations {
  ...
  // App-wide translations (المفاتيح الموجودة مسبقًا)
  ...
  String get logout => _getValue('logout');
    // Error handling translations (newly added for better UX)
  String get noInternetConnection => _getValue('noInternetConnection');
  String get retry => _getValue('retry');
  String get serverError => _getValue('serverError');
  String get invalidResponseFromServer => _getValue('invalidResponseFromServer');
  String get postSaveFailedGeneral => _getValue('postSaveFailedGeneral');
  String get missingDataFromServer => _getValue('missingDataFromServer');
  String get unknownError => _getValue('unknownError');
  String get errorOccurred => _getValue('errorOccurred');
  String get errorOccurredTryAgain => _getValue('errorOccurredTryAgain');
  String get googleSignInFailed => _getValue('googleSignInFailed');
  String get verifyYourEmail => _getValue('verifyYourEmail');
  String get reminderRescheduled => _getValue('reminderRescheduled');
  String get rescheduleReminder => _getValue('rescheduleReminder');
  ...
  String get emailVerificationSuccessful =>
      _getValue('emailVerificationSuccessful');
  String get verifyEmail => _getValue('verifyEmail');
  String get verificationCodeInstructions =>
      _getValue('verificationCodeInstructions');
  String get invalidVerificationCode => _getValue('invalidVerificationCode');
  ...
  String timeRemaining(String time) =>
      _getValue('timeRemaining').replaceFirst('%s', time);
  ...
  String get pleaseVerifyEmail => _getValue('pleaseVerifyEmail');
  String get areYouSureYouWantToGoBack => _getValue('areYouSureYouWantToGoBack');
  ...
  String resendCooldown(int seconds) =>
      _getValue('resendCooldown').replaceFirst('{seconds}', seconds.toString());
  ...
  String get loginSuccessful => _getValue('loginSuccessful');

  // Notification settings translations
  String get saveSettings => _getValue('saveSettings');
  String get silentMode => _getValue('silentMode');
  String get enableSilentMode => _getValue('enableSilentMode');
  String get disableSoundAndVibration => _getValue('disableSoundAndVibration');
  String get soundSettings => _getValue('soundSettings');
  String get enableSound => _getValue('enableSound');
    // No Internet Screen translations
  String get noInternetTitle => _getValue('noInternetTitle');
  String get noInternetDescription => _getValue('noInternetDescription');
  String get troubleshootingTips => _getValue('troubleshootingTips');
  String get checkingConnection => _getValue('checkingConnection');
  String get retryConnection => _getValue('retryConnection');
  String get autoRetryInfo => _getValue('autoRetryInfo');
  String get playNotificationSound => _getValue('playNotificationSound');
  String get notificationSound => _getValue('notificationSound');
  String get volumeLevel => _getValue('volumeLevel');
  String get vibrationSettings => _getValue('vibrationSettings');
  String get enableVibration => _getValue('enableVibration');
  String get vibrateOnNotification => _getValue('vibrateOnNotification');
  String get signInWithGoogle => _getValue('signInWithGoogle');
  String get testNotification => _getValue('testNotification');
  String get information => _getValue('information');
  String get silentModeDisablesSoundAndVibration =>
      _getValue('silentModeDisablesSoundAndVibration');
  String get testSettingsBeforeSaving => _getValue('testSettingsBeforeSaving');
  String get settingsApplyToNewNotifications =>
      _getValue('settingsApplyToNewNotifications');
  String get selectNotificationSound => _getValue('selectNotificationSound');

  // المفاتيح الجديدة المضافة
  String get checkingSubscription => _getValue('checkingSubscription');
  String get premiumSubscribed => _getValue('premiumSubscribed');
  String get manageSubscriptionPrompt => _getValue('manageSubscriptionPrompt');
  String get goToReminders => _getValue('goToReminders');
  String get subscribePrompt => _getValue('subscribePrompt');
  String get showPlans => _getValue('showPlans');
}
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      ['en', 'ar', 'zh'].contains(locale.languageCode);
